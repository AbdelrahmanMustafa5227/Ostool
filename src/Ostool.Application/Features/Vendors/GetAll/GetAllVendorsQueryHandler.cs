...
{
    public record GetAllVendorsQuery(int pageNumber) : IRequest<Result<Paginated<GetAllVendorsResponse>>>, ICacheable
    {
    ...
    internal class GetAllVendorsQueryHandler : IRequestHandler<GetAllVendorsQuery, Result<Paginated<GetAllVendorsResponse>>>
    {
        ...
        public async Task<Result<Paginated<GetAllVendorsResponse>>> Handle(GetAllVendorsQuery request, CancellationToken cancellationToken)
        {
