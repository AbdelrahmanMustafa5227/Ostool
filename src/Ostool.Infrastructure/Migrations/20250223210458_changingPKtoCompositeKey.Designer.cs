...
namespace Ostool.Infrastructure.Migrations
{
    ...
    [Migration("20250223210458_changingPKtoCompositeKey")]
    partial class changingPKtoCompositeKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ostool.Application.Outbox.OutboxMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ostool.Domain.Entities.Favourites", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ostool.Domain.Entities.WatchList", b =>
                {
                    b.Property<Guid>("VisitorId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ostool.Domain.Entities.Favourites", b =>
                {
                    b.HasOne("Ostool.Domain.Entities.Advertisement", "Advertisement")
                        .WithMany("Favorites")
                        .HasForeignKey("AdvertisementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ostool.Domain.Entities.Visitor", "Visitor")
                        .WithMany("SavedAds")
